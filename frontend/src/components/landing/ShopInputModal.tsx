...
export function ShopInputModal({ installHref, onClose }: ShopInputModalProps) {
  ...
  function handleSubmit() {
    ...
    setError(null);
    const base = withTrackingParams(`${installHref}?shop=${normalized}`);
    trackEvent("install_start", { shop: normalized, href: base });
